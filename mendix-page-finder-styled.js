(function () {
    ...
    function showToast(copied) {
        ...
        inner.innerHTML =
            ...
            (popup ? ' <span style="color:#6b7280">[POPUP]</span>' : '') +
            '</span>';

        // Right side: version badge + status + close button
